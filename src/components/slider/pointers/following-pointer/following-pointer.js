...
const FollowingPointer = ({slide, direction, mouseUpAction, handleMouseMove, handleTouchMove, swipeStart, pointerPositionX, pointerPositionY, pointerClassName}) => {
  ...
  const followingPinterClassName = slide === -100 ? 'following-pointer' : 'pointer';
  return(
    <div className={followingPinterClassName} onMouseMove={handleMouseMove} onTouchMove={handleTouchMove} onMouseUp={handleMouseUp} onTouchEnd={handleMouseUp} style={pointerPositionStyles}>
